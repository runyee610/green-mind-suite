...
export default function GreenMfgGovIncubatorDetail() {
  const { id } = useParams();
  ...
  const overviewStats: Array<{ label: string; value: string }> = [
    ...
    { label: "模拟自评价得分", value: `${me.score}` },
    { label: "区级专家评分", value: me.level === "区级" ? `${me.score}` : "—" },
    { label: "市级专家评分", value: me.level === "市级" ? `${me.score}` : "—" },
  ];
      ...
      <Card className="panel mb-4">
        <CardContent className="p-6 space-y-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-base font-semibold leading-tight">{me.name}</div>
            ...
            <div className="space-y-3 lg:border-l lg:border-border/40 lg:pl-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="mt-1 text-sm font-medium">{me.enterDate}</div>
                </div>
                <div>
                    ...
                    >
                      ...
                      <div className="mt-3 flex flex-wrap gap-1.5">
                        ...
                        {t.appliesTo.slice(0, 2).map((k) => (
                          <span key={k} className="rounded-md bg-muted/50 px-2 py-0.5 text-[10px] text-muted-foreground">
                            {k}
                          </span>
                        ))}
                      </div>
