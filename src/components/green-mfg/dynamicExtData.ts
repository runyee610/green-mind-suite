...
export interface GreenArchive {
  ...
  industry: string;
  // 档案档案核心信息
  certifyLevel: "市级绿色工厂" | "区级培育" | "审核推荐中" | "未获评";
  certifyDate?: string; // 首次获评时间
  validUntil?: string;  // 证书有效期
  declarationCount: number;     // 累计审核推荐次数
...
export const MOCK_ARCHIVES: GreenArchive[] = [
  {
    ...
    timeline: [
      ...
      { date: "2024-06-08", type: "审核推荐", title: "提交 2024 年第一批审核推荐", source: "企业", result: "提交" },
    ],
  },
  {
    ...
    timeline: [
      ...
      { date: "2025-09-12", type: "审核推荐", title: "提交 2025 年第二批审核推荐", source: "企业", result: "提交", score: 86 },
...
export const certifyLevelClass = (l: GreenArchive["certifyLevel"]) => {
  switch (l) {
    ...
    case "审核推荐中": return "border-primary/40 bg-primary/10 text-primary";
    default: return "border-muted-foreground/30 bg-muted/40 text-muted-foreground";
  }
};
