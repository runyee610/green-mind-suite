...
const ROUTE_TITLES: Array<{ match: RegExp; crumbs: string[] }> = [
  ...
  { match: /^\/green-mfg\/(gov|ent)\/declaration\/new/, crumbs: ["绿色制造", "审核推荐", "开始评价"] },
  { match: /^\/green-mfg\/(gov|ent)\/declaration\/[^/]+/, crumbs: ["绿色制造", "审核推荐", "详情"] },
  { match: /^\/green-mfg\/(gov|ent)$/, crumbs: ["绿色制造", "审核推荐"] },
